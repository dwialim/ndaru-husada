...
@section('content')
    ...
    {{-- <x-alert-dis message='Selamat Datang. <strong>Heru Rohmadi</strong>.' type='primary'/>
    <x-alert-dis message='3 Obat telah kedaluarsa. <a href="#">Lihat Selengkapnya..</a>' type='warning'/> --}}
    <div class="container-fluid">
    	<div class="row">
    		<!-- page statustic chart start -->
            <div class="col-xl-3 col-md-6">
                <div class="card card-blue text-white py-3">
                    <div class="card-block">
                        <div class="row align-items-center">
                            <div class="col-4">
                                <i class="fas fa-pills f-70"></i>
                            </div>
                            <div class="col-8 text-center">
                                <h3 class="mb-4"><strong> {{ $obat }}</strong></h3>
                                <a href="{{ route('master-barang', ['jenis' => 'Obat']) }}" class="text-white">
                                    <h6 class="mb-0">{{ __('OBAT')}} 
            ...
            {{-- <div class="col-xl-3 col-md-6">
                <div class="card card-green text-white py-3">
                    <div class="card-block">
                        <div class="row align-items-center">
                            <div class="col-4">
                                <i class="fas fa-people-carry f-70"></i>
                            </div>
                            <div class="col-8 text-center">
                                <h3 class="mb-4"><strong> {{ $retail }}</strong></h3>
                                <a href="{{ route('master-barang', ['jenis' => 'Retail']) }}" class="text-white">
                                    <h6 class="mb-0">{{ __('RETAIL')}} 
                                        <i class="fas fa-arrow-right"></i>
                                    </h6>
                                </a>
                            </div>
                ...
                <div class="card bg-secondary text-white py-3">
                    <div class="card-block">
                        <div class="row align-items-center">
                            ...
                            <div class="col-8 text-center">
                                <h3 class="mb-4"><strong> {{ $pbf }}</strong></h3>
                                <a href="{{ route('pbf') }}" class="text-white">
                                    <h6 class="mb-0">{{ __('SUPPLIER')}} 
                                        <i class="fas fa-arrow-right"></i>
                                    </h6>
                                </a>
                            </div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card card-red text-white py-3">
                    <div class="card-block">
                        <div class="row align-items-center">
                            <div class="col-4">
                                {{-- <i class="fas fa-pills f-70"></i> --}}
                                <i class="fas fa-money f-70"></i>
                            </div>
                            <div class="col-8 text-center">
                                <h3 class="mb-4"><strong> {{ $kasir }}</strong></h3>
                                <a href="{{ route('semuaPenjualan') }}" class="text-white">
                                    <h6 class="mb-0">{{ __('KASIR')}} 
                                        <i class="fas fa-arrow-right"></i>
                                    </h6>
                                </a>
                            </div>
