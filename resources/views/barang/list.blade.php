    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header row">
                ...
                <button class="btn btn-primary hidden-print" onclick="myFunction()"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> Cetak Laporan</button>
            </div>
            <div class="card-body">
                <table id="advanced_table" class="table">
                    ...
                    <tbody>
                        @foreach ($barang as $brg)
                            <tr>
                                <td id="leId"> {{ $brg->id }} </td>
                                {{-- <td> {{ $le->nama_barang }} </td> --}}
                                <td> {{ $brg->nama }} </td>
                                {{-- <td> {{ $le->satuan }} </td> --}}
                                <td> {{ $brg->jenis }} </td>
