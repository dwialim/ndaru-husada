				...
				<div class="col-lg-4">
					<nav class="breadcrumb-container" aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item">
								<a href="#">{{ __('Laporan Laba Kotor') }}</a>
							</li>
						</ol>
					</nav>
				</div>
							...
							<div class="col-lg-12">
								...
								<div class="row">
									...
									<div class="col-md-6">
										...
										<strong><p class="float-right mt-1">Total Laba/Kotor: <span id="total">Rp. 0</span></p> </strong>
									</div>
								</div>
							</div>
						</div>
...
@push('script')
	<script>
		...
		function myPrint() {
			...
			$.post("{!! route('printLabaRugi') !!}",{totalLabaRugi:totalLabaRugi,startDate:startDate,endDate:endDate},function(data){
