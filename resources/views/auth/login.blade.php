...
<html class="no-js" lang="en">
    <head> 
        ...
        <title>Login | Ndaru Husada Farma</title>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-7 my-auto p-0">
                        <div class="authentication-form mx-auto">
                            <div class="logo-centered">
                                 <h3><strong>{{ __('NDARU HUSADA FARMA')}}</strong></h3>
                                <p>SELAMAT DATANG KEMBALI <br> SILAHKAN MASUK</p>
                            </div>
                            <form method="POST" action="{{ route('login') }}">
                                @csrf
                                <div class="form-group">
                                    <input id="email" type="email" placeholder="Email" class="form-control @error('email') is-invalid @enderror" name="email"  value="" required>
                                ...
                                <div class="sign-btn text-center">
                                    <button class="btn btn-custom bg-success">Sign In</button>
                                </div>
                                {{-- <div class="register">
                                    <p> Belum memiliki akun? <a href="{{url('register')}}">{{ __('Daftar sekarang')}}</a></p>
                                </div> --}}
                ...
                <div class="row flex-row h-100">
                    <div class="col-xl-4 col-lg-4 col-md-4 m-auto">
                        <div class="authentication-form mx-auto">
                            <div class="logo-centered">
                                <div class="logo-img">
                                    <img height="70", width="85" src="{{ asset('img\image-removebg-preview.png')}}" class="header-brand-img">
                                 </div>
                                 <p>{{ __('NDARU HUSADA FARMA')}}</p>
                            </div>
                            <form method="POST" action="{{ route('login') }}">
                            @csrf
                                <div class="form-group">
