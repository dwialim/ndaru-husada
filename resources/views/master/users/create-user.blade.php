            ...
            <div class="col-md-12">
                <div class="card ">
                    <div class="card-header bg-success">
                        <h3 class="text-white">{{ __('Tambah Data Pengguna Baru')}}</h3>
                    </div>
                    <div class="card-body">
                        ...
                        @csrf
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for="role">{{ __('Pengguna Sebagai')}}<span class="text-red">*</span></label>
