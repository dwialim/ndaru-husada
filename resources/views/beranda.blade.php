      ...
      <div class="row">
        <div class="col-12">
          <nav class="main-nav">
            ...
            <!-- ***** Menu Start ***** -->
            <ul class="nav">
              <li><div class="gradient-button"><a id="modal_trigger" href="{{ URL::to('login') }}"><i class="fa fa-spinner"></i>  </a></div></li> 
            </ul>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="right-image wow" data-wow-duration="1s" data-wow-delay="0.5s">
