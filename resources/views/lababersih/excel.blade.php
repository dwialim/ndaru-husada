...
<table id="excelLaba">
	<thead>
		...
		<tr>
			<th colspan="11"><p style="text-align: right; font-weight: bold;">Total = {{rupiah($total)}} </p></th>
		</tr>
		<tr>
			...
			<th><p style="font-weight:bold;text-align:center">PAJAK</p></th>
			<th><p style="font-weight:bold;text-align:center">SELISIH HARGA</p></th>
			<th><p style="font-weight:bold;text-align:center">LABA BERSIH</p></th>
	...
	<tbody id='panelHasil'>
		...
		<tr>
			...
			<td><p style="padding: 5px;" align="center" valign="middle">{{cekPajak($item->pajak)}}</p></td>
			<td><p style="padding: 5px;" align="center" valign="middle">{{rupiah($item->selisih)}}</p></td>
			<td><p style="padding: 5px;" align="center" valign="middle">{{rupiah($item->lababersih)}}</p></td>
		</tr>
		@php
		$no++;
		@endphp
		...
		@if($no == '1')
		<tr>
			<td colspan="11" style="text-align: center;padding: 5px;">Tidak Ada Data</td>
		</tr>
		@endif
	</tbody>
</table>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#excelLaba').table2excel({
			exclude: ".noExl",
			name: "Laporan Laba Bersih",
			filename: "Laporan Laba Bersih "+output,
			fileext: ".XLSX",
			exclude_img: true,
			exclude_links: true,
			exclude_inputs: true,
